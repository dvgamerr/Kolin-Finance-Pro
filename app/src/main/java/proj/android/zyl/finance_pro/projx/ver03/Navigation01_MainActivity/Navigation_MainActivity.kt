...
class Navigation_MainActivity : Navigation_BaseActivity() {
    private var myViewPager: ViewPager? = null
    private var tabLayout: TabLayout? = null
    private val IconResID = intArrayOf(R.drawable.selector_01_1, R.drawable.selector_01_2, R.drawable.selector_01_3)
    private val TollBarTitle = intArrayOf(R.string.nv_main_readme, R.string.nv_main_welcome, R.string.nv_main_more)
    @Override
    ...
    private fun setViewPager() {
        val myFragment1 = Main_FragmentList_Readme()
        val myFragment2 = Main_FragmentList_Welcome()
        val myFragment3 = Main_FragmentList_More()
